- Cấu trúc dữ liệu: 
	red black TreeMap: private TreeMap<String, List<String>> listData = new TreeMap<>();  
...
- Git: https://github.com/OopsArd/my-dictionary

- Tham khảo:
1. https://viblo.asia/p/sap-xep-voi-comparable-va-comparator-trong-java-WAyK8dOEKxX
2. https://viettuts.vn/java-swing
